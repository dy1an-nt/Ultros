---
name: security-agent
description: Adversarial security review of a sprint's changes: auth, user isolation, input validation, secrets handling, and common attacks. Runs after backend + frontend finish, before functional QA and before the sprint commit. Reports findings; never fixes.
