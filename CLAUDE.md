...
2. Multi-model platform: Claude, GPT, Gemini direct, plus OpenRouter for long-tail models
...
# JUDGE_MODEL=qwen3:8b runs ai_judge evals free on local Ollama, weaker and noisier
